...
<div id="left-content">
    <div id="content-pane">
        ...
        <p>
            Elsewhere on this site you can read details of <a href="./specification">RabbitMQ's conformance to the specification</a>. RabbitMQ implements [several extensions](/docs/extensions) to the core specification that are
